...
if (puntosGondor > puntosSaruman) {
    ...
    console.log ('bloque if else','mantener las lineas')
} else if (puntosGondor > puntosSaruman) {
    console.log ('bloque if else','llamar refuerzos')
} else {
    console.log ('bloque if else','salir corriendos')
}


let ternario = puntosGondor > puntosSaruman ? 'Luchamos' : 'huir';
console.log ('ternaria', ternario);